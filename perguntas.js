...
criaCartao(
    'Filosofia',
    'Qual a ideia principal ideia do ensaio de David Foster Wallace',
    'Pensar na lagosta (obra:pense na lagosta')
...
criaCartao(
    'Japonês',
    'Quantos alfabetos são utilizados na língua japonesa hoje?',
    'Três')
